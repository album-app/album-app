...
public class SolutionLaunchFinishedEvent extends SciJavaEvent {
	private final Solution solution;
	private final String action;
	private final AlbumInstallation installation;

	public SolutionLaunchFinishedEvent(AlbumInstallation installation, Solution solution, String action) {
